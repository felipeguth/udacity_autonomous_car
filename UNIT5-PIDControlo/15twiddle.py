# ----------------
#Twiddle return parameters for minimization of final error
# User Instructions
#
...
############## ADD CODE BELOW ####################
	n_params = 3
	dparams		= [1.0 for row in range(n_params)]#potencial changes
	params		= [0.0 for row in range(n_params)]#parameters
	
	best_error = run(params)
	n = 0 
	print sum(dparams), tol
